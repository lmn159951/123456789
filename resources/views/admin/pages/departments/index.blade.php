...
@section('content')
    ...
    <div class="container-fluid">
        {{ Breadcrumbs::render('departments', $agency) }}
        ...
        <div class="shadow p-4 mb-5 bg-body rounded">
            ...
            <div class="d-flex align-items-center justify-content-end my-2" id="buttonActions">
                <a class="btn btn-primary"
                    href="{{ route('admin.agencies.departments.create', [
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            const table = $('#table-content').DataTable({
                ...
                processing: true,
                serverSide: true,
                ajax: "{!! route('admin.agencies.departments.datatableApi', ['agencySlug' => request()->route('agencySlug')]) !!}",
