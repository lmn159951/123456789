    ...
    <script type="text/javascript">
        $(document).ready(function() {
                ...
                columns: [{
                    ...
                    },
                    {
                        ...
                        render: function(response) {
                            return `<a href="${response.detailsUrl}" style="color: #000;">${response.name}</a>`;
                        }
                    },
                    {
                        data: 'address',
                    ...
                    },
                    {
                        ...
                        render: function(response) {
                            return `
                                <div class="d-flex">
                                    <a class="btn btn-warning text-white mr-2" href="${response.updateUrl}">
                                        <i class="fas fa-fw fa-pen"></i>
                                    </a>

                                    <button type="button" id="button-delete" class="btn btn-danger"
                                    data-toggle="modal" data-target="#deleteModal-${response.id}" data-destroyUrl="${response.destroyUrl}">
            ...
            $(document).on('click', '#button-delete', function(event) {
                $('#deleteModal form').attr('action', $(this).attr('data-destroyUrl'));
